#!/bin/bash
#SBATCH --job-name=run_notebook_Hypocreaceae_BuildBUSCOtree_SameSpecies
#SBATCH --cpus-per-task=32
#SBATCH --mem=150G
#SBATCH --output=run_notebook_Hypocreaceae_BuildBUSCOtree_SameSpecies.%j.out
#SBATCH --error=run_notebook_Hypocreaceae_BuildBUSCOtree_SameSpecies.%j.err
#SBATCH --partition=YOUR_PARTITION   # set this to your cluster's partition/account

# Input Jupyter Notebook file
NOTEBOOK_FILE="BuildBUSCOTree_SameSpecies.ipynb"
